...
namespace ProyectCore.DAL.Models
{
    public partial class ProyectCoreContext : DbContext
    {
        public ProyectCoreContext()
        {
        }

        public ProyectCoreContext(DbContextOptions<ProyectCoreContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=LAPTOP-B74J5CAV\\SQLEXPRESS;Database=ProyectCore; user ID=UserProyectCore; Password= 123456");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserProjects>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    .WithMany(p => p.UserProjects)
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__UserProje__UserI__48CFD27E");
            });
        }
    }
}
